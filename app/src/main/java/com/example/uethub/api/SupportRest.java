...
public class SupportRest {
    ...
    private static final String hostURL2 = "https://uetplus.azurewebsites.net";
    ...
    public static String delete(String url) {
        ...
        try {
            ...
            Log.v("uetplus", "DELETE REQUEST is : " + httpCon.getRequestMethod() + " " + httpCon.getURL());

            response = httpCon.getResponseMessage();
            Log.v("uetplus", "JSON DELETE RESPONSE : " + response);
        }

        catch (Exception e) {
            Log.v("uetplus","DELETE REQUEST ERROR" + e.getMessage());
        }
    ...
    public static String post(String url, String json) {
        ...
        try {
            ...
            Log.v("uetplus", "POST REQUEST is : " + httpCon.getRequestMethod() + " " + httpCon.getURL());
            ...
            if(HttpResult == HttpURLConnection.HTTP_OK) {
                ...
                Log.v("uetplus", "JSON POST RESPONSE : " + stringBuilder.toString());
            }
        }

        catch (Exception e) {
            Log.v("uetplus","POST REQUEST ERROR" + e.getMessage());
        }
